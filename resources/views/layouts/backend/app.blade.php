...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy;
                {{ date('Y') }}<a class="ml-25" href="#" target="_blank">Copyright © Himpunan Mahasiswa
                    Elektro 2025</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span
